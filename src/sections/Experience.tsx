...
function ExperienceItem({
  ...
  const scale = useTransform(progress, [0, 0.2, 1], [0.6, 1, 1]);
  ...
  if (layout === "desktop") {
    return (
      <div className="relative flex flex-1 justify-center items-center min-w-0">
        <motion.div
          className="z-10 w-7 h-7 rounded-full bg-white relative"
          style={{ scale, opacity }}
        >
          <motion.div
  ...
  return (
    <div className="relative flex items-start">
      <motion.div
        className="absolute -left-[14px] top-3 z-10 w-7 h-7 rounded-full bg-white relative"
        style={{ scale, opacity }}
      >
        <motion.div
          className="absolute inset-0 rounded-full bg-white/30 blur-md"
