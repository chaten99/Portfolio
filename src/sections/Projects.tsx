        ...
        <div className={`relative w-full flex-1 flex items-center justify-center ${
          ...
          {projects.map((project, idx) => (
            ...
            >
              ...
              <div  className={`relative w-full overflow-hidden bg-black/20 shadow-2xl md:shadow-[0_35px_60px_-15px_rgba(0,0,0,0.7)] ${isMobile ? "mg-6 rounded-lg" : "mb-10 sm:mb-12 rounded-xl" } h-[62vh] sm:h-[66vh]`}
              style={{zIndex:10, transition: "box-shadow 250ms ease"}}
                >
                <img src={project.image} alt={project.title} 
                className="w-full h-full object-cover drop-shadow-xl md:dropshadow-2xl"
                style={{position: "relative",
                  zIndex: 10,
                  filter: "drops-shadow(0, 16px 40px rgba(0,0,0,0.65))",
